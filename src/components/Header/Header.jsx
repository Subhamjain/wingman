  ...
  return (
    <div className="flex space-x-4 p-6 mb-12 border-b border-b-[--header-border-color] fixed bg-white w-full z-10">
      <button
        ...
        className={`rounded-3xl px-4 py-2 flex items-center text-lg ${buttonClass(0)}`}
      >
        <span className="mr-3">
      ...
      <button
        ...
        className={`rounded-3xl px-4 py-2 flex items-center text-lg ${buttonClass(1)}`}
      >
        <span className="mr-3">
          <FaTag size={20} />
        </span>
      ...
      <button
        ...
        className={`rounded-3xl px-4 py-2 flex items-center text-lg ${buttonClass(2)}`}
      >
        <span className="mr-3">
